...
書いた文章は AI に校正させることもできます。APIキーのほか、ChatGPT / GitHub Copilotのサブスクも使用できます。
...
* AI に文章を校正させることができる（APIキーもしくはChatGPT / GitHub Copilot のサブスクが必要）
...
AI校正を使うには、APIキーかサブスクの接続設定が必要です。設定していなくても、メモ帳として使うことができます。
